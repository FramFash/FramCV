...
<div class="main-container">
  ...
  <h3>Propel Pivot GT</h3>
  <p>
    basados en las graficas anteriores, la "Propel Pivot GT" es el producto que mejor oferta
    y relación costo beneficio otorga, siendo que tiene todas las capacidades de otros productos
    de casi el doble de precio y ofreciendo mas ventajas como el peso, que para un medio de transporte
    portatil ofrece una gran ventaja.
  </p>
